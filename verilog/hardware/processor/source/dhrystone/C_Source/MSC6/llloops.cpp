 ...
 *  be copied and pasted into this program. See // Values at the start
 *  end of checkOut(). These values are for optimised compiling and non-
 ...
 ************************************************************************/
    for ( section=0 ; section<3 ; section++ )
    {
        ...
        {
             local_time();
             fprintf (outfile, " Part %d of 3 start at %s\n", section + 1, timeday);
             fflush(outfile);
        }
...
/*
    ...
    {
        fprintf(outfile, " Classic Benchmark Float Loops Ratings for CPUSpeed.txt where 100 MHz Pentium = 100\n");
        fprintf (outfile, " Maximum Geomean Minimum\n");
        fprintf (outfile, "%8.0f%8.0f%8.0f\n\n",
            maximum[3] / 31.05 * 100, geometric[3] / 11.49 * 100, minimum[3] / 1.96 * 100);
    }
*/
    if (!reliability)
    {
    ...
    if (reliability)
    {
        ...
        if (count2 == 1)
        {
            ...
            if (strcmp (chek1, chek2)  != 0)
            {
                ...
                fprintf(outfile, " Section %d Test %2d pass %5d Non-standard result was %s expected %s\n",
        ...
        else
        {
            ...
            if (strcmp (chek1, chek2)  != 0)
            {
                ...
                if (failCount < 6)
                {
                    fprintf(outfile, " Section %d Test %2d pass %5d Different result was %s expected %s\n",
                                       i+1, j, count2, chek1, chek2);
                    fflush(outfile);
                }
            }
